...
while ! curl -s -f http://169.254.169.250/2015-12-19/stacks/Kubernetes/services/kubernetes/uuid; do
...
UUID=$(curl -s http://169.254.169.250/2015-12-19/stacks/Kubernetes/services/kubernetes/uuid)
